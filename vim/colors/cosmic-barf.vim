...
call <SID>X('SpecialComment', s:base03, '',       '')
...
" Git "{{{
" ----------------------------------------------------------------------
call <SID>X('gitcommitComment',       s:base03, '',       '')
...
call <SID>X('hsLineComment',         s:base03, '',       '')
